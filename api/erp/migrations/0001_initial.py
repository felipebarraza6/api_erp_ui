    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flow_rates', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_internal', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_file', models.CharField(blank=True, max_length=1200, null=True)),
                ('is_file', models.BooleanField(default=False)),
                ('is_info', models.BooleanField(default=True)),
                ('section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='erp.sectionelement')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charge_present', models.CharField(blank=True, max_length=655, null=True)),
                ('img_present', models.ImageField(blank=True, null=True, upload_to='webinars/presents/')),
                ('wallpaper_img', models.ImageField(blank=True, null=True, upload_to='webinars/wallpapers/')),
                ('date_time_webinar', models.DateTimeField()),
                ('link_meet', models.CharField(blank=True, max_length=3000, null=True)),
                ('is_active', models.BooleanField(default=False)),
                ('description', models.TextField(blank=True, max_length=1200, null=True)),
                ('txt_date', models.CharField(blank=True, max_length=400, null=True)),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='files_clients')),
                ('note', models.TextField(blank=True, max_length=1200, null=True)),
                ('is_approved', models.BooleanField(default=False)),
                ('is_read', models.BooleanField(default=False)),
                ('is_cancel', models.BooleanField(default=False)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erp.project')),
                ('type_element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erp.typeelement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('support_section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='erp.supportsection')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created', '-modified'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charge', models.TextField(blank=True, max_length=30, null=True)),
                ('phone_number', models.CharField(blank=True, max_length=17, null=True, validators=[django.core.validators.RegexValidator(message='El número de telefono debe ingresarse en el formato: +9999999. Se permiten hasta 15 dígitos.', regex='\\+?1?\\d{9,15}$')])),
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='is Active')),
                ('enterprise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erp.client')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webinar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='erp.webinars')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_support', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erp.ticketsupport')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='client_action', to='erp.client')),
                ('employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employee_action', to='erp.employee')),
                ('type_action', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='type_action', to='erp.typeaction')),
