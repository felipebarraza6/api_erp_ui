...
class ExternalClient(ModelApi):
    ...
    address_enterprise = models.CharField(
    ...
    workload = models.CharField(max_length=1200, blank=True, null=True)
...
class Client(ModelApi):
    ...
    # General
    # APR
    administered = models.TextField(choices=[(
        'Comite', 'Comite'), ('Cooperativa', 'Cooperativa')], null=False, blank=True)
