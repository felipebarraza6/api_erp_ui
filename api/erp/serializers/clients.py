...
# Models
from api.erp.models import ChargeWorkload, EconomicActivity, ExternalClient, TechnicalInfo, Client, Employee

# Serializers
from api.erp.serializers.employees import EmployeeModelSerializer




class ChargeWorkloadModelSerializer(serializers.ModelSerializer):
    class Meta:
