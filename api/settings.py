...
LOCAL_APPS = [
    'api.erp.apps.ErpAppConfig',
    'django_crontab'
]

"""CRONJOBS = [
    ('0 * * * *', 'api.erp.cron.main',  '>> ' + os.path.join(BASE_DIR,'api/log/debug7.log' + ' 2>&1 ')),
    ('* * * * *', 'api.erp.cron_dga.main',  '>> ' + os.path.join(BASE_DIR,'api/log/debug_crondga.log' + ' 2>&1 '))
]"""
