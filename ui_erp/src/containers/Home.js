          ...
          <Sider style={styles.sider} width={"300px"}>
            ...
            >
              ...
              <Menu.SubMenu
                ...
                title={
                  <>
                    <ProfileFilled /> Levantamientos de pozos
                  </>
                }
              >
                <Menu.Item key="13" icon={<UnorderedListOutlined />}>
                  <Link to="/external_lifting">Levantamientos externos</Link>
                </Menu.Item>
                <Menu.Item key="12" icon={<OrderedListOutlined />}>
                  <Link to="/internal_lifting">Levantamientos internos</Link>
                </Menu.Item>
              </Menu.SubMenu>
              <Menu.SubMenu
                key="4"
                title={
                  <>
                    <FolderOutlined /> Proyectos
                  </>
                }
              >
                <Menu.Item key="8" icon={<FolderOpenOutlined />}>
                  <Link to="/projects">Gestionar proyectos</Link>
                </Menu.Item>
                <Menu.Item key="9" icon={<SlidersFilled />}>
                  <Link to="/config_entry">Elementos</Link>
                </Menu.Item>
                <Menu.Item key="10" icon={<ApartmentOutlined />}>
                  <Link to="/config_deparments">Departamentos</Link>
                </Menu.Item>
              </Menu.SubMenu>
              <Menu.Item key="7" icon={<UnorderedListOutlined />}>
                <Link to="/actions">Gestión de Tareas</Link>
              </Menu.Item>
            </Menu>
          </Sider>
        )}
          ...
          <Content>
            <div style={{ padding: 24, minHeight: 360, textAlign: "left" }}>
              <Switch>
                ...
                <Route
                  exact
                  path="/external_lifting"
                  component={ExternalLiftings}
                />
                <Route
                  exact
                  path="/internal_lifting"
                  component={InternalLifftings}
                />
