...
const InternalLifftings = () => {
  ...
  function modalDataWells(wells) {
    Modal.info({
      ...
      okText: "Volver",
      content:<> 
      <Row style={{backgroundColor:'red'}}>a</Row>
                    ...
                    >
                      <Collapse.Panel key="1" header="Datos generales">
                        <Descriptions size="small" bordered>
                          ...
                          {x.link_location && (
                            <Descriptions.Item
                              span={3}
                              label={<>Link ubicación</>}
                            >
                              <a href={x.link_location} target="__blank">
                                Ver link
                              </a>
                            </Descriptions.Item>
                          )}
                      ...
                      <Collapse.Panel key="2" header="Datos del pozo">
                        <Descriptions size="small" bordered>
                          ...
                          >
                            {x.flow_granted_dga &&
                              parseFloat(x.flow_granted_dga).toFixed(2)}{" "}
                            <span style={styles.span}>(Lt/SEG)</span>
                          </Descriptions.Item>
                          <Descriptions.Item
                            span={3}
                            label={<>Profundida instalación bomba</>}
                          >
                            {x.pupm_depth &&
                              parseFloat(x.pupm_depth).toFixed(2)}{" "}
                            <span style={styles.span}>(Mt)</span>
                          </Descriptions.Item>
                          <Descriptions.Item
                            span={3}
                          ...
                          >
                            {x.inside_diameter &&
                              parseFloat(x.inside_diameter).toFixed(2)}{" "}
                            <span style={styles.span}>(MM/PULG)</span>
                          </Descriptions.Item>
                          <Descriptions.Item
                            span={3}
                            label={<>Diámetro exterior ducto salida bomba</>}
                          >
                            {x.outside_diameter &&
                              parseFloat(x.outside_diameter).toFixed(2)}{" "}
                            <span style={styles.span}>(MM/PULG)</span>
                          </Descriptions.Item>
                          <Descriptions.Item
                            span={3}
                            label={<>Profundida total del pozo</>}
                          >
                            {x.depth && parseFloat(x.depth).toFixed(2)}{" "}
                            <span style={styles.span}>(Mt)</span>
                          </Descriptions.Item>
                          <Descriptions.Item
                            span={3}
                          ...
                          <Descriptions.Item
                            span={3}
                            label={<>Cuenta con flujometro? </>}
                          >
                            {x.is_sensor_flow ? "SI" : "NO"}
                          </Descriptions.Item>
                          <Descriptions.Item
                            span={3}
                            label={<>Cuenta con factibilidad electrica? </>}
                          >
                            ...
                            >
                              <Tooltip title="Has click para abrir la imagén!">
                                <a
                                  ...
                                  onClick={() =>
                                    window.open(`${BASE_URL_IMG}${file.photo}`)
                                  }
                                >
                                  <img
                                    src={`${BASE_URL_IMG}${file.photo}`}
                                    style={{
                                      width: "100%",
                                      borderRadius: "10px",
                                    }}
  ...
  return (
    <>
      <a href="/liftings/internal" target="__blank">
        <Button
          style={{ marginBottom: "10px", borderRadius: "5px" }}
          type="primary"
        >
          Nuevo levantamiento interno
        </Button>
      </a>
      <Table
        bordered
            ...
            render: (x) => (
              <>
                <Button
                  type="primary"
                  style={{ borderRadius: "10px" }}
                  onClick={() => ModalEnterprise(x.client)}
                >
                  {x.client.name}
                </Button>
              </>
