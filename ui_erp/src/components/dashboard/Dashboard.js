                ...
                <Col span={24}>
                    <Card>
                        <Card.Grid style={{height:'100px', width:'25%'}}>
                            <Row>
                                <Col style={{marginRight:'20px'}}>
                                    <BookTwoTone style={{fontSize:'20px', marginLeft:'20%'}} />
                                </Col>
                                <Col >
                                    <Statistic title="TOTAL" value={state.totals.total}  />
                                </Col>
                                <Col>
                        ...
                        <Card.Grid style={{height:'100px', width:'25%'}}>
                            <Row>
                                <Col style={{marginRight:'20px'}}>
                                    <AlertTwoTone style={{fontSize:'20px', marginLeft:'20%'}} />
                                </Col>
                                <Col >
                                    <Statistic title="ACTIVAS" value={state.totals.actives} />
                                </Col>
                                <Col>
                                    <Tooltip  title="Filtrar">
                                        <Button size='small' onClick={ () => {
                        ...
                        <Card.Grid style={{height:'100px', width:'25%'}} >
                            <Row>
                                <Col style={{marginRight:'20px'}}>
                                    <WarningTwoTone style={{fontSize:'20px', marginLeft:'20%'}} />
                                </Col>
                                <Col>
                                    <Statistic title="PRIORIDAD" value={state.totals.priority} />
                                </Col>
                                <Col>
                                    <Tooltip  title="Filtrar">
                                        <Button size='small' onClick={() => { priorityTasks() }} style={{ marginLeft:'40px', marginTop:'20px'}} type="primary" shape="circle" icon={<FilterOutlined />} />
                                    </Tooltip>
                                </Col>
                            </Row>
                        </Card.Grid>
                        <Card.Grid style={{height:'100px', width:'25%'}} >
                            <Row>
                                <Col style={{marginRight:'20px'}}>
                                    <CheckCircleTwoTone style={{fontSize:'20px', marginLeft:'20%'}} />
                                </Col>
                                <Col>
                                    <Statistic title="COMPLETAS" value={state.totals.completes}  />
                                </Col>
                                <Col>
                                    <Tooltip  title="Filtrar">
                                        <Button size='small' onClick={() => { completesTasks() }} style={{ marginLeft:'40px', marginTop:'20px'}} type="primary" shape="circle" icon={<FilterOutlined />} />
                                    </Tooltip>
                                </Col>
                            </Row>
                        </Card.Grid>
