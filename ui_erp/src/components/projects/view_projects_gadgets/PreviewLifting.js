        ...
        {lifting.is_external ? (
          <>
            <Descriptions.Item label="Nombre contacto" span={3}>
              <b>{external_client.name_contact}</b>
            </Descriptions.Item>
            <Descriptions.Item label="Teléfono" span={3}>
              <b>{external_client.phone_contact}</b>
            </Descriptions.Item>
            <Descriptions.Item label="Email" span={3}>
              <b>{external_client.mail_contact}</b>
            </Descriptions.Item>
            <Descriptions.Item label="Cargo contacto" span={3}>
              <b>{external_client.workload}</b>
            </Descriptions.Item>
            <Descriptions.Item label="Nombre empresa" span={3}>
              <b>{external_client.name_enterprise}</b>
            </Descriptions.Item>
            <Descriptions.Item label="Dirección empresa" span={3}>
              <b>{external_client.address_enterprise}</b>
            </Descriptions.Item>
          </>
        ) : (
          <>
    ...
    <Row style={{ marginTop: "-90px" }}>
      <Col style={styles.col} span={24}>
        {lifting && (
          <Card hoverable>
            {ViewClient(lifting)}
            <ModalWells wells={lifting.wells} />
            <br />
            <br />
            FECHA CREACIÓN: <b>{lifting.created.slice(0, 10)}</b>
            <br />
